// Generated by @wagmi/cli@0.1.10 on 3/26/2023 at 6:26:13 AM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link poaPcetABI}__ and `functionName` set to `"readPOAPID"`.
 */
export function usePoaPcetReadPoapid<
  TSelectData = ReadContractResult<typeof poaPcetABI, 'readPOAPID'>,
>(
  config: Omit<
    UseContractReadConfig<typeof poaPcetABI, 'readPOAPID', TSelectData>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return useContractRead({
    abi: poaPcetABI,
    functionName: 'readPOAPID',
    ...config,
  } as UseContractReadConfig<typeof poaPcetABI, 'readPOAPID', TSelectData>)
}
